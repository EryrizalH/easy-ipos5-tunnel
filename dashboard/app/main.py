...
def build_supported_clients(public_ip: str, control_port: str) -> list[dict[str, str]]:
    ...
    return [
        ...
        },
        {
            ...
            "delivery": "Paket ZIP (setup.exe + client.toml)",
            "binary_source": f"Runtime offline sudah ada di dalam {WINDOWS_UNIFIED_NAME}",
            "setup_hint": "Ekstrak, pastikan client.toml berdampingan dengan setup.exe, lalu jalankan sebagai Administrator.",
            "remote_endpoint": endpoint,
        },
        {
            "platform": "Windows 7",
            ...
            "service_name": WINDOWS_SERVICE_NAME,
            "delivery": "Paket ZIP (setup.exe + client.toml)",
            "binary_source": f"Runtime offline Win7 sudah ada di dalam {WINDOWS_UNIFIED_NAME}",
            "setup_hint": "Ekstrak, pastikan client.toml berdampingan dengan setup.exe, lalu jalankan sebagai Administrator.",
            "remote_endpoint": endpoint,
        },
    ]
